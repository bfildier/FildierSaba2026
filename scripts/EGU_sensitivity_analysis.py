...
DEFAULT_DATA_PATH = Path(
    "/home/saba/Documents/ObedSaba/RECONCILE-PROJECT/code_cwt/algo_version_5/"
)

DEFAULT_OUT_DIR = Path("Sensitivity_figures")
...
def load_all_data(args) -> tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame, pd.DataFrame, pd.DataFrame]:
    ...
    tbmin_csv = _find_csv_strict(
        ...
        data_path=data_path,
        filename="tbseed_sensitivity_all_cases_summary.csv",
        label="Tbmin",
        relative_candidates=[
    ...
    sigma_csv = _find_csv_strict(
        ...
        data_path=data_path,
        filename="sigma_sensitivity_all_cases.csv",
        label="sigma",
        relative_candidates=[
    ...
    lambda_max_csv = _find_csv_strict(
        ...
        data_path=data_path,
        filename="lambda_max_sensitivity_all_cases.csv",
        label="lambda_max",
        relative_candidates=[
    ...
    delta_t_csv = _find_csv_strict(
        ...
        data_path=data_path,
        filename="delta_t_sensitivity_all_cases.csv",
        label="delta_t",
        relative_candidates=[
    ...
    lambda_min_csv = _find_csv_strict(
        ...
        data_path=data_path,
        filename="lambda_min_sensitivity_all_cases.csv",
        label="lambda_min",
        relative_candidates=[
